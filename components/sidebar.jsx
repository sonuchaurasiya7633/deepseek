...
const Sidebar = ({ expand, setExpand }) => {
  ...
  const [openMenu, setOpenMenu] = useState({ id: 0, open: false }); // useState is now defined
  ...
  return (
    ...
    >
      <div>
        ...
        <button
          className={`mt-8 ml-5 flex items-center justify-center cursor-pointer ${
            expand
      ...
      <div>
        <div
          className={`flex items-center cursor-pointer group relative ${
            expand
              ? 'gap-1 text-white/180 text-sm p-2.5 border border-primary rounded-lg hover:bg-white/10 cursor-pointer'
        ...
        >
          ...
          {expand && (
            <>
              <span>Get App</span> <Image alt="New Icon" src={assets.new_icon} />
            </>
          )}
        </div>
